...
class RiskSettings:
    ...
    enforce_exchange_leverage_limit: bool = True
    ...
    profit_giveback_guard_enabled: bool = True
    ...
    post_profit_reentry_guard_enabled: bool = True
...
def load_settings(env_file: str | Path = ".env") -> Settings:
    ...
    risk = RiskSettings(
        ...
        enforce_exchange_leverage_limit=_bool(
            _get(merged, "ENFORCE_EXCHANGE_LEVERAGE_LIMIT", "true")
        ),
        ...
        profit_giveback_guard_enabled=_bool(_get(merged, "PROFIT_GIVEBACK_GUARD_ENABLED", "true")),
        profit_giveback_activation_r=_decimal(_get(merged, "PROFIT_GIVEBACK_ACTIVATION_R", "1.0")),
        profit_giveback_lock_fraction=_decimal(_get(merged, "PROFIT_GIVEBACK_LOCK_FRACTION", "0.50")),
        profit_giveback_min_lock_r=_decimal(_get(merged, "PROFIT_GIVEBACK_MIN_LOCK_R", "0.25")),
        profit_giveback_tighten_after_r=_decimal(_get(merged, "PROFIT_GIVEBACK_TIGHTEN_AFTER_R", "3.0")),
        profit_giveback_tighten_fraction=_decimal(_get(merged, "PROFIT_GIVEBACK_TIGHTEN_FRACTION", "0.70")),
        post_profit_reentry_guard_enabled=_bool(_get(merged, "POST_PROFIT_REENTRY_GUARD_ENABLED", "true")),
        post_profit_reentry_cooldown_candles=int(_get(merged, "POST_PROFIT_REENTRY_COOLDOWN_CANDLES", "12")),
        post_profit_reentry_pullback_atr=_decimal(_get(merged, "POST_PROFIT_REENTRY_PULLBACK_ATR", "0.75")),
        post_profit_reentry_pullback_pct=_decimal(_get(merged, "POST_PROFIT_REENTRY_PULLBACK_PCT", "1.0")),
